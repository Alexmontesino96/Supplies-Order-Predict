...
auth = Auth0(domain=auth_domain, api_audience =auth_audience, scopes={"read:product": "Read Products"})
...
class Auth0User(BaseModel):
    ...
    email:             Optional[str] = Field(None, alias="https://github.com/dorinclisu/fastapi-auth0/email")  # type: ignore [literal-required]
